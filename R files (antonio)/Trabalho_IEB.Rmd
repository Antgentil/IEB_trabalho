...
output:
  pdf_document:
    ...
    number_sections: true     # numera as secções
  html_document:
    df_print: paged
    toc: true                 # índice só no HTML
    toc_depth: 2
    number_sections: true
header-includes:
  - \usepackage[hidelinks]{hyperref}   # links clicáveis sem caixas coloridas
  - \hypersetup{linktoc=all}          # torna todo o texto do índice clicável
---
\begin{titlepage}
\begin{center}
...
**INE – Rendimento médio mensal líquido** 
[3] Instituto Nacional de Estatística (INE), *Rendimento médio mensal líquido (Série 2021 - €) da população empregada por conta de outrem por Local de residência (NUTS - 2024) e Setor de atividade económica (CAE Rev. 3); Trimestral – Inquérito ao Emprego (Série 2021)*,  
...
**INE – Emprego no setor terciário** 
[4] Instituto Nacional de Estatística (INE), *Proporção de população empregada no setor terciário (Série 2021, CAE Rev. 3 - %) por Local de residência (NUTS - 2024); Anual – Inquérito ao Emprego (Série 2021)*,  
...
**INE – População ativa por grupos etários** 
[5] Instituto Nacional de Estatística (INE), *População ativa com idade entre 16 e 74 anos (N.º) por Grupo etário; Mensal – Estatísticas Mensais de Emprego e Desemprego com base no Inquérito ao Emprego*,  
