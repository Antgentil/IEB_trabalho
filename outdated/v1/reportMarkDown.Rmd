...
Neste caso também vemos linhas azuis em todos os valores (maior que 0.5), 
indicando um bom rácio do tamanho de amostras efetivas.

## Previsões

Com o nosso modelo avaliado, tentamos prever o desemprego com a media dos nossos
posterioris. A imagem abaixo demonstra a diferença entre os valores previstos e 
os valores originais dos dados.
